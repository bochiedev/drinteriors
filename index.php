...
?>
    ...
    <div id="content">
        ...
        <div class="container-fluid nopadding block">
            <div class="clip">
                <div class="bg fix" style="background: #232322;">
                    <div class="bg-layer-6"></div>
                </div>
            </div>
            <div class="empty-space h35-xs h100-md" style="background: #232322;"></div>
            <div class="empty-space h30-xs" style="background: #232322;"></div>
