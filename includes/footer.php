    ...
    <div class="container small-sm">
        <div class="row">
            ...
            <div class="col-md-2 col-md-offset-1">
                ...
                <ul>
                    <li>
                        <a href="tel:+380982367536">tel. +254 711 293 905</a>
                    </li>
                    <li>
                        <a href="tel:+380982367536">tel. +254 735 009 487</a>
                    </li>
                    <li>
                        <a href="mailto:info@bristol.com">e-mail info@drinteriors.com</a>
                    </li>
                </ul>
            </div>
            <div class="empty-space h20-xs h0-md"></div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="copyright">
                    &copy; <?php echo date("Y"); ?> All rights reserved. Development with <span class="fa fa-heart"></span> by <a href="https://bochie.co.ke" target="blank">Bochie ltd</a>
                </div>
            </div>
        </div>
    </div>
