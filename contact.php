...
<head>
    ...
    <title>DRINTERIORS | Contact Us</title>
</head>
<body>
  <?php
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-3 col-xs-12">
                    <div class="project-info">
                       ...
                       <div class="empty-space h20-xs"></div>
                       <a href="tel:+380 00 876 35 44">+254 735 009 487</a>
                       <a href="tel:+380 00 876 66 55">+254 711 293 905</a>
                       <div class="empty-space h60-md h30-xs"></div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-3 col-xs-12">
                    <div class="project-info">
                       ...
                       <div class="empty-space h20-xs"></div>
                       <a href="mailto:myfrilanceremail@email.com">info@drinteriors.co.ke</a>
            ...
            <div class="testimonial-form-wrapper shop">
                ...
                <form action="#">
                   ...
                   <div class="text-center">
                       <div class="btn-wrap"><a href="#" class="btn-2"><input type="submit" value=""><span>Send Message</span></a></div>
                   </div>
                </form>
            </div>
            </div>
